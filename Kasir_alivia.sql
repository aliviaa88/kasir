...
--
-- Host: localhost
-- Waktu pembuatan: 21 Jun 2025 pada 18.05
...
(1, 'Alivia', 'Ujung Berung Bandung', '081234567890', 'example@gmail.com', 'unnamed.jpg', '12314121');
...
(1, 'Alivia Toko', 'Jl Ujung Berung - Bandung', '081234567', 'Alivia');
...
--
ALTER TABLE `detail_transaksi`
  ADD CONSTRAINT `detail_transaksi_ibfk_1` FOREIGN KEY (`id_transaksi`) REFERENCES `transactions` (`id_transaksi`) ON DELETE CASCADE,
